...
do
    ...
    if [ $stage == "6.uvfits" ]
    then
	SET_EHTIMPATH="/home/swc/github/eht-imaging" && SET_SRCDIR=/home/iniyan/2021-hops-calibration/tutorial-25jun/2021-april/dev-template/hops-b2/5.+close/data && SET_CORRDAT="Rev1-Cal" && source bin/0.launch
